            ...
            <div className="cart__products">
              <div className="cart__product">
                ...
                <div className="cart__product-details">
                  <p className="cart__product-title">Gradient Graphic T-shirt</p>
                  <p className="cart__product-size">Size: <span>Large</span></p>
                  <p className="cart__product-color">Color: <span>Black</span></p>
                  <p className="cart__product-price">$145</p>
                </div>
                <div className="cart__product-options">
                  <button className="cart__product-delete">
                  ...
                  <div className="cart__product-quantity">
                    <span className="cart__product-quantity-decrement">
                    ...
                    <span className="cart__product-quantity-count">1</span>
                    <span className="cart__product-quantity-increment">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
